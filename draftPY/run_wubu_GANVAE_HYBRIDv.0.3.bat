...
SET "CHECKPOINT_OUTPUT_DIR=D:/wubugen/video"
REM "CHECKPOINT_OUTPUT_DIR=%PROJECT_ROOT%\checkpoints\WuBuGAADHybridGen_v03_Run_Latest"
SET "VIDEO_DATA_PATH=%DATA_DIR_BASE%\demo_video_data_dir_dft_dct"
SET "VALIDATION_VIDEO_PATH="
SET "BEST_CKPT_NAME=wubugaad_hybridgen_v03_dft_dct_ep36_step9036.pt"
SET "LOAD_CHECKPOINT="
...
SET "SPECTRAL_PATCH_SIZE_H=8"
SET "SPECTRAL_PATCH_SIZE_W=8"
SET "DFT_NORM_SCALE_VIDEO=25.0"
SET "DFT_FFT_NORM=ortho"
SET "DCT_NORM_TYPE=none"
...
SET "ENCODER_SHALLOW_CNN_CHANNELS=96"
SET "ENCODER_INITIAL_TANGENT_DIM=512"
...
REM =====================================================================
SET "DISC_APPLY_SPECTRAL_NORM=false"
SET "DISC_BASE_DISC_CHANNELS=128"
...
SET "DISC_MAX_HIDDEN_FC_DIM=768"
...
SET "DISC_GLOBAL_STATS_MLP_HIDDEN_DIM_VIDEO_GLOBAL_WUBU=128"
...
SET "WUBU_S_HYPERBOLIC_DIMS=768 512 256 128"
SET "WUBU_S_INITIAL_CURVATURES=1.0 0.8 0.6 0.4"
SET "WUBU_S_INITIAL_SCALES=1.0"
SET "WUBU_S_INITIAL_SPREAD_VALUES=0.1"
SET "WUBU_S_BOUNDARY_POINTS_PER_LEVEL=8"
...
SET "WUBU_T_HYPERBOLIC_DIMS=512 256"
SET "WUBU_T_INITIAL_CURVATURES=1.0 0.8"
SET "WUBU_T_INITIAL_SCALES=1.0"
SET "WUBU_T_INITIAL_SPREAD_VALUES=0.1"
SET "WUBU_T_BOUNDARY_POINTS_PER_LEVEL=4"
...
REM =====================================================================
SET "WUBU_D_GLOBAL_VIDEO_NUM_LEVELS=2"
SET "WUBU_D_GLOBAL_VIDEO_HYPERBOLIC_DIMS=256 128"
SET "WUBU_D_GLOBAL_VIDEO_INITIAL_CURVATURES=0.9 0.7"
...
SET "RISGD_MAX_GRAD_NORM=3.0"
SET "GLOBAL_MAX_GRAD_NORM=3.0"
SET "TRAIN_SEED=1337"
...
SET "MIN_LAMBDA_KL_Q_CONTROL=1e-1"
SET "MAX_LAMBDA_KL_Q_CONTROL=0.9"
SET "Q_LKL_SCALE_OPTIONS=0.75 0.9 1.0 1.1 1.25"
SET "Q_LKL_LR_MOM_PROBATION_STEPS=10"
SET "Q_LKL_ACTION_PROBATION_STEPS=50"

SET "ENABLE_HEURISTIC_INTERVENTIONS=true"
SET "HEURISTIC_CHECK_INTERVAL=10"
SET "HEURISTIC_SHORT_TERM_HISTORY_LEN=10"
SET "HEURISTIC_TRIGGER_COUNT_THRESH=5"
SET "HEURISTIC_D_STRONG_THRESH=0.10"
SET "HEURISTIC_D_WEAK_THRESH=1.5"
...
SET "HEURISTIC_KL_HIGH_THRESH=45.0"
SET "HEURISTIC_RECON_STAGNATION_IMPROVEMENT_THRESH_REL=0.0003"
SET "TARGET_GOOD_RECON_THRESH_HEURISTIC_VIDEO=0.010"
SET "HEURISTIC_Q_REWARD_STAGNATION_THRESH=-0.3"
SET "HEURISTIC_RECON_BOOST_FACTOR_VIDEO=1.5"
SET "LAMBDA_FEAT_MATCH_HEURISTIC_VIDEO=0.15"
...
SET "HEURISTIC_D_Q_EXPLORE_DURATION=50"
SET "HEURISTIC_MIN_LAMBDA_GAN_FACTOR=0.75"
SET "HEURISTIC_MAX_LAMBDA_GAN_FACTOR=1.25"
...
SET "VAL_PRIMARY_METRIC=avg_val_lpips"
...
SET "WANDB_RUN_NAME="
SET "WANDB_LOG_TRAIN_RECON_INTERVAL=100"
SET "WANDB_LOG_FIXED_NOISE_SAMPLES_INTERVAL=1000"
