...
REM OriginalFMT specific params - only relevant if USE_MANIFOLD_UNCRUMPLE_TRANSFORM is false
...
SET "MODEL_WUBU_NUM_VIRTUAL_LEVELS=16"
SET "MODEL_WUBU_BASE_MICRO_DIM=4"
SET "MODEL_WUBU_NUM_PHYSICAL_STAGES=8"
...
SET "USE_BSP_GATE=false" 
SET "BSP_GATE_HIDDEN_DIM=512"
SET "BSP_NUM_PATHS=8" 
SET "BSP_INTERMEDIATE_DIM=256"
...
ECHO ======================================================
ECHO WuBuDiffusion V1 - CPU Execution (Advanced FDQWR ^& BSP/MUT)
...
ECHO OriginalFMT Advanced Features: ISP=%WUBU_ENABLE_ISP%, Stateful=%WUBU_ENABLE_STATEFUL%, HyperNet=%WUBU_ENABLE_HYPERNET%
