...
SET "MASTER_PORT=29514"

SET "DATA_DIR_BASE=%PROJECT_ROOT%\data"
SET "CHECKPOINT_OUTPUT_DIR=%PROJECT_ROOT%\checkpoints\WuBuGAADHybridGen_v01_Run_Latest"
...
SET "LAMBDA_KL_UPDATE_INTERVAL=1"
...
ECHO Generator Temporal Kernel: %GEN_TEMPORAL_KERNEL_SIZE%
ECHO Discriminator Type: %DISCRIMINATOR_TYPE%
ECHO Discriminator GAAD FiLM: %DISC_USE_GAAD_FILM_CONDITION% (Note: Only applies if type is spatio_temporal_cnn)
