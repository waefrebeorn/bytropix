...
SET "WUBU_D_NUM_LEVELS=1"
SET "WUBU_D_HYPERBOLIC_DIMS=64"
SET "WUBU_D_INITIAL_CURVATURES=0.7"
...
SET "TRAIN_LOG_INTERVAL=50"
SET "TRAIN_SAVE_INTERVAL=1000"
SET "TRAIN_SEED=42"
...
SET "DB_NORM_MAX=0.0"
SET "PRELOAD_AUDIO_DATASET_TO_RAM=false"

SET "USE_LPIPS_FOR_MEL_VERIFICATION=false"
