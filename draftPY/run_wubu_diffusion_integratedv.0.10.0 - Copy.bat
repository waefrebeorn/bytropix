@echo OFF
REM ==================================================================================
REM Batch file for WuBuNestDiffusion_v0.10.0 - Run 1 (Based on v052 Run 3)
REM Goal: Enable all features, including motion branch, using the new Regional Latent AE.
...
SET "SCRIPT_DIR=%~dp0"
SET "SCRIPT_NAME=WuBuNestDiffusion_v0.10.0_GAAD_RegionalLatent.py"
SET "FULL_SCRIPT_PATH=%SCRIPT_DIR%%SCRIPT_NAME%"

REM --- DDP Settings ---
SET "NPROC_PER_NODE=1"
SET "MASTER_ADDR=localhost"
SET "MASTER_PORT=29510"

REM --- Data and Output Directories ---
SET "DATA_DIR_BASE=%PROJECT_ROOT%\data"
SET "CHECKPOINT_OUTPUT_DIR=%PROJECT_ROOT%\checkpoints\WuBuRegional_v010_Run1_AllFeatures_Anomaly"
...
REM --- Motion Branch Parameters (Enabled) ---
...
REM --- Transformer Noise Predictor Parameters (NEW) ---
...
REM IF DEFINED USE_AMP IF /I "%USE_AMP%"=="true" SET "SCRIPT_ARGS=%SCRIPT_ARGS% --use_amp"
...
SET "SCRIPT_ARGS=%SCRIPT_ARGS% --wandb --wandb_project WuBuRegionalDiff_v010_AllFeat_Anomaly"


REM --- Environment Activation & Execution ---
ECHO ======================================================
ECHO WuBu GAAD Regional Latent Diffusion - V0.10.0 RUN 1
