...
REM =====================================================================
REM RESUME SCRIPT for WuBuGAADHybridGen_v0.1.py - Phase 2a: KL Annealing (lambda_kl = 0.001)
REM CORRECTED BATCH SYNTAX FOR SCRIPT_ARGS
REM =====================================================================
...
SET "CHECKPOINT_OUTPUT_DIR=%PROJECT_ROOT%\checkpoints\WuBuGAADHybridGen_v01_Phase2a_KL001"
SET "VIDEO_DATA_PATH=%DATA_DIR_BASE%\demo_video_data_dir"
SET "VALIDATION_VIDEO_PATH="

REM --- !!! KEY CHANGES FOR THIS PHASE (Phase 2a) !!! ---
SET "LOAD_CHECKPOINT=%PROJECT_ROOT%\checkpoints\WuBuGAADHybridGen_v01_Run_Latest\wubugaad_hybridgen_ckpt_v01_best.pt"
SET "LAMBDA_KL=0.001"
SET "EPOCHS=15"
SET "WANDB_RUN_NAME=Phase2a_KL0.001_FromBestEp7_v2"

REM --- Parameters carried over from the previous successful configuration ---
...
SET "DISC_USE_GAAD_FILM_CONDITION=false"
...
REM --- Construct SCRIPT_ARGS (Corrected: Each on a new line) ---
SET "SCRIPT_ARGS="
...
ECHO ======================================================
ECHO WuBuGAADHybridGen VAE-GAN - Phase 2a: KL Anneal (lambda_kl=%LAMBDA_KL%)
...
ECHO Starting training script: %SCRIPT_NAME% (Phase 2a - lambda_kl=%LAMBDA_KL%)
