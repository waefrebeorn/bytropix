...
SET "ENC_WUBU_NUM_VIRTUAL_LEVELS=800"
SET "ENC_WUBU_BASE_MICRO_DIM=4"
SET "ENC_WUBU_NUM_PHYSICAL_STAGES=80"

SET "GEN_WUBU_NUM_VIRTUAL_LEVELS=1000"
SET "GEN_WUBU_BASE_MICRO_DIM=4"
SET "GEN_WUBU_NUM_PHYSICAL_STAGES=1000"

SET "DISC_WUBU_NUM_VIRTUAL_LEVELS=400"
SET "DISC_WUBU_BASE_MICRO_DIM=4"
SET "DISC_WUBU_NUM_PHYSICAL_STAGES=40"
...
SET "WANDB_LOG_FIXED_NOISE_SAMPLES_INTERVAL=25"
