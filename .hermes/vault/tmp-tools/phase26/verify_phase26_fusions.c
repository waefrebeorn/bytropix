...
int main(int argc, char **argv) {
    ...
    printf("\n=== Verification 2: ssm_conv_silu_split_decode ===\n");
    {
        ...
        float *d_qkv_out = d_scratch + (size_t)8 * dr;
        float *d_z_out   = d_scratch + (size_t)8 * dr + (size_t)N * qdim;
        // But d_scratch needs to be big enough. Let me use fresh allocations.
