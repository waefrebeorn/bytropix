...
- **attn_output_gate: True** — official Qwen config. wubuwizard doesn't gate attention outputs with sigmoid(blk.X.attn_gate.weight). This is likely causing "Doug" vs ref "Here".
