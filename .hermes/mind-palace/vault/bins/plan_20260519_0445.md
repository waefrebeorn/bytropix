...
Root cause hypothesis: quantization path differences (wubuwizard quantized_matmul vs llama.cpp ggml_mul_mat) produce slightly different per-layer outputs, compounded by recurrence in SSM layers.
