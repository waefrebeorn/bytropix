...
- RC01 THE 35M TRAINING RECIPE (research/041-wubu35m-training-recipe.md): the canonical numbers -- batch 0.5-1M tok/step, warmup 2000, cosine to 10%, wd 0.1, clip 1.0; Muon (NS5, coefs 3.4445/-4.7750/2.0315, mom 0.95, Nesterov, fp32 buffer, NO bias corr, Muon lr 2e-2 + AdamW lr 2e-3, wd 0.1 both); overtrain 10-100x Chinchilla; repeat <=4 epochs; embed+head TIED (16K vocab x 448 = 21% of 35M params). CONFIRMS our audit: muon_update in barun_train is momentum SGD (missing NS), layer_grad is not backprop.
