...
- AN11: DEEPSEEK-V4-FLASH-0731 CONFIG-I ARCHITECTURE (research/059 — the file, not the marketing): 121.9B params, 19 blocks (blk.18 reduced), MLA 32768 (256h×128), MoE 256×top-6 (gate/up Q2_0 + down TQ3_1S, 2.15B each per layer), hash-router tid2eid I32 (blk 0-2), mHC 24-dim bodies, DSA indexer (8 layers), KV compressor + sinks. Load gate PASSED on the real header (566 tensors, 7 types, 0 mismatches). All building blocks exist in-tree; wubu_deepseek4 forward = next phase.
