...
- BL04 Bounded SwiGLU (activation clip 10) `wired` (wubu)
- BL05 Residual selectors every 4 layers (convex softmax) `wired` (wubu)
- BL06 Tied embeddings (lm_head == embedding) `wired` (wubu)
- BL07 The released checkpoint loader (safetensors, SHA-256 verified) `wired` (wubu_load)
