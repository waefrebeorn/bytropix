...
`test_200, test_256k, test_256k_chunked, test_256k_context, test_256k_forward, test_300, test_400, test_4kv, test_512k_budget, test_adaptive_hotpath, test_affinity, test_agentic_kv, test_agentic_os_mem, test_agi_os_integration, test_align, test_all, test_ambig, test_amoeba, test_arena, test_attn_gate, test_attn_kernels, test_attn_tune, test_attnres, test_awq, test_ax, test_axi, test_backprop, test_backward, test_backward_simple, test_bf16_gemv, test_bi, test_bonzi, test_bonzi2, test_bridge, test_bridge2, test_btl3_lora, test_bwd_model, test_cache_advice, test_capacity_wall, test_capzero` — run the full gate with `make test_all` (subset) / the
...
| Doc | Topic |
|---|---|
| [001-kv-entropy-ecco.md](research/001-kv-entropy-ecco.md) | 001 — KV entropy-aware adaptive compression (Ecco, ISCA'25) |
| [002-kv-multitier.md](research/002-kv-multitier.md) | 002 — Predictive multi-tier KV cache (DRAM / NVMe / CXL / IB) |
| [002-triple-da-staging.md](research/002-triple-da-staging.md) | Triple-DA Staging Report |
| [003-weight-int4-gemv.md](research/003-weight-int4-gemv.md) | 003 — int4 weight-only GEMV (Marlin-style packing) |
| [004-bitnet-158.md](research/004-bitnet-158.md) | 004 — BitNet 1.58 ternary GEMV ({-1,0,+1}) |
| [005-smoothquant.md](research/005-smoothquant.md) | 005 — SmoothQuant activation-outlier migration |
| [006-arena-allocator.md](research/006-arena-allocator.md) | 006 — Arena allocator + SoA layout (game-console data-oriented design) |
| [007-7step-plan.md](research/007-7step-plan.md) | 7-Step Plan: wubuwizard Inference Engine + OS Integration |
| [007-continuous-batching.md](research/007-continuous-batching.md) | 007 — Continuous (iteration-level) batching |
| [008-gated-deltanet.md](research/008-gated-deltanet.md) | 008 — Gated-DeltaNet 3:1 hybrid linear attention |
| [009-kernel-equivalence.md](research/009-kernel-equivalence.md) | 009 — Bounded equivalence testing of quantized kernels |
| [010-prefix-kv-reuse.md](research/010-prefix-kv-reuse.md) | 010 — Prefix KV-cache reuse across requests |
| [011-attention-sink-free.md](research/011-attention-sink-free.md) | 011 — Attention-sink-free gated attention (kills massive activations) |
| [012-speculative-decoding.md](research/012-speculative-decoding.md) | 012 — Speculative decoding (EAGLE / MEDUSA self-draft) |
| [013-quarot-hadamard.md](research/013-quarot-hadamard.md) | 013 — Hadamard rotation kills outliers → 4-bit W+A+KV lossless (QuaRot / SpinQuant) |
| [014-kv-vector-quant.md](research/014-kv-vector-quant.md) | 014 — Sub-4-bit KV via data-independent vector quantization (CommVQ / TurboQuant) |
| [015-flashdecoding.md](research/015-flashdecoding.md) | 015 — Parallel KV-load decode attention (FlashDecoding) |
| [016-numa-pinning.md](research/016-numa-pinning.md) | 016 — NUMA-aware thread pinning (+19–21% throughput) |
| [017-layer-skip.md](research/017-layer-skip.md) | 017 — Token-wise layer skipping (GateSkip / LayerSkip / Mixture-of-Depths) |
| [018-cascade-speculative.md](research/018-cascade-speculative.md) | 018 — Cascade speculative decoding (small drafter + large verifier) |
| [041-wubu35m-training-recipe.md](research/041-wubu35m-training-recipe.md) | WuBu-35M Training Recipe — How Frontier Labs Actually Train Small LLMs (35M–1B) |
| [042-data-curation-pipeline.md](research/042-data-curation-pipeline.md) | LLM Pretraining Data Curation — Best-Practice Report |
| [042-kaze-deep-dive-and-7hop.md](research/042-kaze-deep-dive-and-7hop.md) | 042 — Kaze Emanuar: deep dive + the 7-hop Kevin-Bacon from his work |
| [043-individuals-deep-dive.md](research/043-individuals-deep-dive.md) | 043 — The individuals, deep-dived: Tri Dao, Zhiqi Bu, and the console underground |
| [043-rlhf-rlvr-implementation.md](research/043-rlhf-rlvr-implementation.md) | RLHF / RLVR Implementation Report for WuBu-35M |
| [044-agentic-corpus-deep-dive-and-7hop.md](research/044-agentic-corpus-deep-dive-and-7hop.md) | The AGI-user corpus deep-dive and 7-hop chain (2026-08-04) |
| [044-amoeba-grow-shrink-plan.md](research/044-amoeba-grow-shrink-plan.md) | 044 — The Amoeba Full-Body: all parts grow AND shrink |
| [045-agentic-corpus-mix-recipe.md](research/045-agentic-corpus-mix-recipe.md) | The WuBu-35M agentic corpus-mix recipe (2026-08-04) |
| [045-blt-expanded-tokenization.md](research/045-blt-expanded-tokenization.md) | 045 — Expanded tokenization for simpler depth (BLT) |
| [046-escha-heterogeneous-precision.md](research/046-escha-heterogeneous-precision.md) | 046 — Heterogeneous precision: the Escha axis (bit-width is an amoeba parameter) |
| [046-growth-deep-dive-and-7hop.md](research/046-growth-deep-dive-and-7hop.md) | The fast-training + model-growth deep-dive and 7-hop chain (2026-08-04) |
| [047-knowledge-substrate-ponds.md](research/047-knowledge-substrate-ponds.md) | 047 — Knowledge substrate: the 7 research ponds (701 MB pure text) |
| [048-sft-corpus-light-tiers.md](research/048-sft-corpus-light-tiers.md) | 048 — SFT cold-start corpus: the light DeepSeek/GLM interaction tiers |
| [049-agentic-mini-datasets.md](research/049-agentic-mini-datasets.md) | 049 — Agentic mini-datasets: the OS-backbone tiers |
| [049-triple-da-metaplan.md](research/049-triple-da-metaplan.md) | Triple-DA Meta-Plan: the recursive gap-closing loop's own plan |
| [050-training-methodology-7hop.md](research/050-training-methodology-7hop.md) | 050 — Training Methodology 7-Hop: what the labs that trained good AI actually do |
| [051-triple-da-amoeba-spheres-vs-labs.md](research/051-triple-da-amoeba-spheres-vs-labs.md) | 051 — Triple-DA: the amoeba-on-nested-spheres methodology vs the lab convergence |
| [052-7hop-through-our-research-next-steps.md](research/052-7hop-through-our-research-next-steps.md) | 052 — The 7-hop through OUR research: what to do right now |
| [053-small-model-gains-playbook.md](research/053-small-model-gains-playbook.md) | 053 — Small-model gains: the Smol Training Playbook + lab convergence (7-hop online) |
| [054-mega-tokens-amoeba-tokenizer.md](research/054-mega-tokens-amoeba-tokenizer.md) | 054 — Mega-tokens & the amoeba tokenizer (vocab as a grow/shrink organ) |
| [055-architecture-matrix-7hop.md](research/055-architecture-matrix-7hop.md) | research/055 — The Architecture Matrix: 7-hop through OUR OWN project |
| [056-hive-diagnostic-system.md](research/056-hive-diagnostic-system.md) | research/056 — THE HIVE DIAGNOSTIC SYSTEM (the superior AGI diagnostic) |
| [057-mixed-compression-iq2m.md](research/057-mixed-compression-iq2m.md) | research/057 — MIXED COMPRESSION: the IQ2_M / Unsloth 7-hop (quality density) |
| [058-faster-better-accuracy-7hop.md](research/058-faster-better-accuracy-7hop.md) | research/058 — FASTER + BETTER ACCURACY at low bits: the 7-hop |
| [059-deepseek4-architecture.md](research/059-deepseek4-architecture.md) | research/059 — DeepSeek-V4-Flash-0731 Config-I: the architecture, from the file |
...
*Repo hygiene: 305 C modules, 348 test tools, 45 research docs (auto-audited — run `tools/repodoc/repodoc.py .` to refresh).*
<!-- repodoc:END -->
