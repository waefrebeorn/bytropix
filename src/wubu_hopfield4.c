/*
 * wubu_hopfield4.c -- the associative-memory frontier, ABSOLUTE final (IP). C11.
 * Implements the 26 remaining IP gaps (IP05-IP67 minus those already in
 * wubu_hopfield2/3). The declarations are in wubu_hopfield3.h.
 */
